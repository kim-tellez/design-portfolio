            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-sm-6 col-md-6 col-lg-8">
                        ...
                        <br />
                        <p>
                        &#127758; I've had the privilege to live in Mexico, the US (MA, NH, CO, TX), Ecuador, Brazil, Czechia, and Guatemala. I've also travelled to 20 other countries. Ask me for travel stories! <br /><br />
