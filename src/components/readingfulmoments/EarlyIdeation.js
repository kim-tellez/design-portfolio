    ...
    return (
        <div className="container-fluid ideation pt-5 pb-5">
            <div className="container">
                ...
                <br />
                <a href={userflows} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid pb-5" alt="User Flows" src={userflows} /></a>
                <h4>Sketches</h4>
                <div className="d-flex justify-content-center"><a href={sketches} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Sketches" src={sketches} /></a></div>
                <h4 className="pt-5 pb-3">Early Wireframes</h4>
                <div className="d-flex justify-content-center"><a href={early} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid pb-5" alt="Early Wireframes" src={early} /></a></div>
                <h4>Challenges</h4><br />
                <p>
                ...
                <div className="d-flex justify-content-center pml">
                    <div className="row pt-5">
                        ...
                        <a href={round1} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 1" src={round1} /></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="d-flex justify-content-center pml">
                    <div className="row pt-5">
                        ...
                        <a href={round2} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 2" src={round2} /></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="d-flex justify-content-center pml3 pt-2 pb-3">
                    ...
                    <div className="row">
                        ...
                        <a href={round3pt1} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 3 (On Phone)" src={round3pt1} /></a>
                        </div>
                        <div className="col-lg-1 col-md-1 col-sm-1 pt-5"></div>
                        <div className="col-lg-7 col-md-7 col-sm-auto pt-5">
                        <div className="d-flex justify-content-center"><a href={round3pt2} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 3 (Mascot)" src={round3pt2} /></a></div>< br />
                        ...
                        <div className="d-flex justify-content-center"><a href={round3pt3} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 3 (Progress Indicator and Coaching Tip)" src={round3pt3} /></a></div><br />
                        ...
                        <div className="d-flex justify-content-center"><a href={round3pt4} className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Mid-Fi Mock-Ups - Round 3 (Bottom Nav)" src={round3pt4} /></a></div><br />
