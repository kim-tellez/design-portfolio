    ...
    return (
        <div className="container-fluid pt-5 pb-5">
            ...
            <h3 className="mb-4">Design Sprint Day 3: Create a Storyboard</h3>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-sm-4"><div className="d-flex justify-content-center pt-3"><a href={storyboard1} target="_blank" rel="noreferrer" className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Storyboard 1" src={storyboard1} /></a></div></div>
                    <div className="col-lg-4 col-md-4 col-sm-4"><div className="d-flex justify-content-center pt-3"><a href={storyboard2} target="_blank" rel="noreferrer" className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Storyboard 2" src={storyboard2} /></a></div></div>
                    <div className="col-lg-4 col-md-4 col-sm-4"><div className="d-flex justify-content-center pt-3"><a href={storyboard3} target="_blank" rel="noreferrer" className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Storyboard 3" src={storyboard3} /></a></div></div>
                </div>

                <h4 className="mb-5 mt-5">Aha! Moment</h4>
                <div className="row">
                    <div className="col-lg-4 col-md-auto col-sm-auto">
                    <a href={main} target="_blank" rel="noreferrer" className="MagicThumb" data-options="expandEasing:cubic-bezier(.09,.63,0,.99);"><img className="img-fluid" alt="Main Elements of a Cafe" src={main} /></a>
                    </div>
